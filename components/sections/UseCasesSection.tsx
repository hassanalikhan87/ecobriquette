...
export default function UseCasesSection({
  ...
  return (
    <SectionWrapper>
      <SectionHeading
        eyebrow="Use cases"
        title="Scalable biomass conversion, perfectly matched to each ecosystem’s needs
"
        description="Transforming biomass waste into carbon removal, community value, and soil regeneration."
      />
